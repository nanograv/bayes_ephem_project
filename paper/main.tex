...
% \author{M. Vallisneri, S. R. Taylor, J. Simon, J. A. Ellis, S. J. Vigeland, T. J. W. Lazio, C. Cutler, [NANOGrav list], W. M. Folkner, and R. S. Park}
...
\begin{figure*}[t]
    ...
    Parameters names follow JPL's orbit-determination package \cite{moyer2003}. % page 3-13
...
% then author support in author-list order
...
% check if these are ordered, complete, and what's missing
...
% close with JPL/NASA for JPL review purposes
