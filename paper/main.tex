...
All computational results presented in this article were obtained with \textsc{Enterprise}  \citep{enterprise}, used in conjunction with the stochastic sampler \textsc{PTMCMCSampler}\footnote{\href{https://github.com/jellis18/PTMCMCSampler}{https://github.com/jellis18/PTMCMCSampler}} and the pulsar-timing package \textsc{Tempo2} \citep{2012ascl.soft10015H}.
...
\begin{figure*}[t]
    ...
    Here $a$ is the semimajor axis of the orbit, $e$ the eccentricity, $\i$ the inclination, $\ell$ the mean longitude, $\varomega$ the longitude of the periapsis, and $\Omega$ the longitude of the ascending node. 
